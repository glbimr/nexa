...
export type SignalType = 'OFFER' | 'ANSWER' | 'CANDIDATE' | 'HANGUP' | 'CHAT_MSG' | 'CHAT_MESSAGE' | 'USER_ONLINE' | 'SCREEN_STARTED' | 'SCREEN_STOPPED' | 'ADD_TO_CALL' | 'BUSY' | 'WAIT_NOTIFY' | 'CHECK_MEETING_PRESENCE';
